...
J = 0;
czsfrrrrrrrrrrrr = zeros(size(Theta1));
...
%Compute the unregularized cost according to ex4.pdf (top of Page 5), using a3, your y_matrix, and m (the number of training examples). 
%Note that the 'h' argument inside the log() function is exactly a3. Cost should be a scalar value. 
...
total =  sum(sum(theta1_seq)) + sum(sum(theta2_seq));
